...
LP_NET = edict()
LP_NET.NUM_LAYERS = 101
LP_NET.DECONV_WITH_BIAS = False
LP_NET.NUM_DECONV_LAYERS = 3
LP_NET.NUM_DECONV_FILTERS = [256, 256, 256]
LP_NET.NUM_DECONV_KERNELS = [4, 4, 4]
LP_NET.FINAL_CONV_KERNEL = 1
LP_NET.TARGET_TYPE = 'gaussian'
LP_NET.HEATMAP_SIZE = [128, 128]  # width * height, ex: 24 * 32
LP_NET.SIGMA = 2
LP_NET.USE_GCB = True
...
config.DATASET.ROOT = ''
config.DATASET.DATASET = 'LumbarDataset'
